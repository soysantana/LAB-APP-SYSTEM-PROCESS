<?php
$page_title = 'listado de muestras enviadas';
        ...
        <div class="panel panel-default">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="tabla3" class="table table-bordered table-striped dt-responsive tablaProductos" width="100%">
                        <thead>
                            <tr>
...
foreach ($tablas as $tabla) {
    $query = "SELECT id, Sample_ID, Sample_Number, Sample_Type, Depth_From, Depth_To, Sample_Length, Sample_Weight, Comment, Sample_Date, Store_In FROM $tabla WHERE Store_In = 'Sended_To'";
...
$(document).ready(function () {
    $("#btnBuscar").click(function () {
        ...
        $("#tabla3 tbody tr").filter(function () {
