...
function calcular() {
 // obtenemos los valores de la parte gruesa
    ...
    var WDS = parseFloat(document.getElementById("1").value)|| 0;
    var Ww = parseFloat(document.getElementById("2").value)|| 0;

    var WR4 = parseFloat(document.getElementById("4").value)|| 0;
    var WR3P5 = parseFloat(document.getElementById("7").value)|| 0;
    var WR3 = parseFloat(document.getElementById("10").value)|| 0;
    var WR2P5= parseFloat(document.getElementById("13").value)|| 0;
    var WR2 = parseFloat(document.getElementById("16").value)|| 0;
    var WR1P5 = parseFloat(document.getElementById("19").value)|| 0;
    var WR1 = parseFloat(document.getElementById("22").value)|| 0;
    var WR3P4 = parseFloat(document.getElementById("25").value)|| 0;
    var WR1P2= parseFloat(document.getElementById("28").value)|| 0;
    var WR3P8 = parseFloat(document.getElementById("31").value)|| 0;
    var WRN4 = parseFloat(document.getElementById("34").value)|| 0;
...
// obtenemos los valores de la parte fina.
    ...
    var WRN4f = parseFloat(document.getElementById("40").value)|| 0;
    var WRN8 = parseFloat(document.getElementById("43").value)|| 0;
    var WRN16 = parseFloat(document.getElementById("46").value)|| 0;
    var WRN30 = parseFloat(document.getElementById("49").value)|| 0;
    var WRN50 = parseFloat(document.getElementById("52").value)|| 0;
    var WRN100 = parseFloat(document.getElementById("55").value)|| 0;
    var Wpan= parseFloat(document.getElementById("58").value)|| 0;
...
// Fine Aggregate Soundness test
   ...
   var StwRN = parseFloat(document.getElementById("122.1").value)|| 0;
   var StwRN100  =  parseFloat(document.getElementById("125.1").value)|| 0;
   var StwRN50  =  parseFloat(document.getElementById("128.1").value)|| 0;
   var StwRN30  =  parseFloat(document.getElementById("131.1").value)|| 0;
   var StwRN16  =  parseFloat(document.getElementById("134.1").value)|| 0;
   var StwRN8  =  parseFloat(document.getElementById("137.1").value)|| 0;
    var StwRN4  =  parseFloat(document.getElementById("140.1").value)|| 0;


  var FwRN =  parseFloat(document.getElementById("122").value)|| 0;
  var FwRN100 =  parseFloat(document.getElementById("125").value)|| 0;
  var FwRN50 =  parseFloat(document.getElementById("128").value)|| 0;
  var FwRN30 =  parseFloat(document.getElementById("131").value)|| 0;
  var FwRN16=  parseFloat(document.getElementById("134").value)|| 0;
  var FwRN8 =  parseFloat(document.getElementById("137").value)|| 0;
  var FwRN4 =  parseFloat(document.getElementById("140").value)|| 0;
   
   var TsWr = StwRN + StwRN100+ StwRN50 + StwRN30 + StwRN16 + StwRN8 + StwRN4;
   var TfWrn = FwRN + FwRN100 + FwRN50 + FwRN30 + FwRN16 + FwRN8+ FwRN4;





   // Porcentaje pasante designado.
  ...
  if (PPdn === ""){
    ...
    PPdn= ((StwRN - FwRN)/ StwRN)* 100;
  }

  if (PPdn100 === ""){
    PPdn100 = "";
  }else{
    PPdn100=  ((StwRN100 - FwRN100)/ StwRN100)* 100;
  }

  if (PPdn50=== ""){
    PPdn50 = "";
  }else{
    PPdn50=  ((StwRN50 - FwRN50)/ StwRN50)* 100;
  }

  if (PPdn30=== ""){
    PPdn30 = "";
  }else{
    PPdn30=  ((StwRN30 - FwRN30)/ StwRN30)* 100;
  }

  if (PPdn16=== ""){
    PPdn16 = "";
  }else{
    PPdn16= ((StwRN16 - FwRN16)/ StwRN16)* 100;
  }

  if (PPdn8 === ""){
    PPdn8 = "";
  }else{
    PPdn8 = ((StwRN8 - FwRN8)/ StwRN8)* 100;
  }

  if (PPdn4 === ""){
    PPdn4 = "";
  }else{
    PPdn4 = ((StwRN4 - FwRN4)/ StwRN4)* 100;
  }
  ...
  var WpMn4 = (PPdn4 * pRN4f) / 100;


 
var valores = [WpMn100, WpMn50, WpMn30, WpMn16, WpMn8, WpMn4 ];

// La condición que deseas aplicar (por ejemplo, mayor o igual a 0)
var condicion = 0;

var suma = 0;

for (var i = 0; i < valores.length; i++) {
  if (valores[i] >= condicion) {
    suma += valores[i];
  }
}
...
document.getElementById("123").value = PPdn.toFixed(2);
document.getElementById("126").value = PPdn100.toFixed(2);
document.getElementById("129").value = PPdn50.toFixed(2);
document.getElementById("132").value = PPdn30.toFixed(2);
document.getElementById("135").value = PPdn16.toFixed(2);
document.getElementById("138").value = PPdn8.toFixed(2);
document.getElementById("141").value = PPdn4.toFixed(2);
document.getElementById("143.1").value = TsWr.toFixed(2);
document.getElementById("143").value = TfWrn.toFixed(2);

document.getElementById("127").value = WpMn100.toFixed(2);
document.getElementById("130").value = WpMn50.toFixed(2);
document.getElementById("133").value = WpMn30.toFixed(2);
document.getElementById("136").value = WpMn16.toFixed(2);
document.getElementById("139").value = WpMn8.toFixed(2);
document.getElementById("142").value = WpMn4.toFixed(2);

document.getElementById("145").value = suma;
