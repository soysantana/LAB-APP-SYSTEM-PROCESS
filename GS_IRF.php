    ...
    <table class="table table-bordered border-primary" style="width: 850px; height: 20px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" value="100" name="50-100" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" value="0-100" name="" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" value="0-45" name="" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" value="0-25" name="" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
                ...
                <td><input type="text" value="0-14" name="" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
                ...
                <td><input type="text" value="0-8" name="" style="border: none;" size="12" style="background: transparent;"id=""oninput="calcular()"></td> 
            </tr>
            <tr>
...
<div style="display: flex; justify-content: center; margin-left: 20%; margin-top: -1%;">
    <div id="gs_irf" style="width: 1080px; height: 700px;"></div>
</div>
