    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs3p89" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo44" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="74" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo102" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="79" oninput="calcular()"></td>
          </tr>
          <tr>
...
<div>
  <div id="gs_utf" style="height: 600px; width: 1070px; display: flex; flex-direction: row-reverse; margin-top: -25%;"></div>
</div>
