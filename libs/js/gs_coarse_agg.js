var dom = document.getElementById('gs_coarse_agg');
  ...
  series: [
    {
       data: [
        ...
        [12.7, document.getElementById(55).value],
        [9.5, document.getElementById(61).value],
        [4.75, document.getElementById(73).value],
        [2.00, document.getElementById(79).value],
        [1.18, document.getElementById(84).value],
        [0.85, document.getElementById(89).value],
        [0.30, document.getElementById(94).value],
