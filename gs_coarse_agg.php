    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          <tr>
            ...
            <td>127</td>
            <td><input type="text" name="WtRet5127" style="text-align: center; border: none;" size="4" style="background: transparent;"id="17" oninput="calcular()"></td>
            <td><input type="text" name="PorceRet5127" style="text-align: center; border: none;" size="4" style="background: transparent;"id="18" oninput="calcular()"></td>
            <td><input type="text" name="CumRet5127" style="text-align: center; border: none;" size="4" style="background: transparent;"id="19" oninput="calcular()"></td>
            <td><input type="text" name="PorcePass5127" style="text-align: center; border: none;" size="4" style="background: transparent;"id="20" oninput="calcular()"></td>
            <td><input type="text" name="Specs5127" style="text-align: center; border: none;" size="4" style="background: transparent;"id="21" oninput="calcular()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs250" style="text-align: center; border: none;" size="4" style="background: transparent;"id="45" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="Specs1p537" value="100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="51" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs125" value="87-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="57" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs3p419" value="80-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="63" oninput="calcular()"></td>
            </tr>
          <tr>
            ...
            <td><input type="text" name="Specs3p89" value="40-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo44" value="7-60"style="text-align: center; border: none;" size="4" style="background: transparent;"id="75" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="SpecsNo102" value="0-15"style="text-align: center; border: none;" size="4" style="background: transparent;"id="80" oninput="calcular()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>0.85</td>
            <td><input type="text" name="WtRetNo200p85" style="text-align: center; border: none;" size="4" style="background: transparent;"id="86" oninput="calcular()"></td>
            <td><input type="text" name="PorceRetNo200p85" style="text-align: center; border: none;" size="4" style="background: transparent;"id="87" oninput="calcular()"></td>
            <td><input type="text" name="CumRetNo200p85" style="text-align: center; border: none;" size="4" style="background: transparent;"id="88" oninput="calcular()"></td>
            <td><input type="text" name="PorcePassNo200p85" style="text-align: center; border: none;" size="4" style="background: transparent;"id="89" oninput="calcular()"></td>
            <td><input type="text" name="SpecsNo200p85" value="0-7" style="text-align: center; border: none;" size="4" style="background: transparent;"id="90" oninput="calcular()"></td>
            
          </tr>
          <tr>
            <th style="text-align: center;" scope="row">No. 50</th>
            <td>0.30</td>
            <td><input type="text" name="WtRetNo500p3" style="text-align: center; border: none;" size="4" style="background: transparent;"id="91" oninput="calcular()"></td>
            <td><input type="text" name="PorceRetNo500p3" style="text-align: center; border: none;" size="4" style="background: transparent;"id="92" oninput="calcular()"></td>
            <td><input type="text" name="CumRetNo500p3" style="text-align: center; border: none;" size="4" style="background: transparent;"id="93" oninput="calcular()"></td>
            <td><input type="text" name="PorcePassNo500p3" style="text-align: center; border: none;" size="4" style="background: transparent;"id="94" oninput="calcular()"></td>          
            <td><input type="text" name="SpecsNo500p3" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="90" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo600p25" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="90" oninput="calcular()"></td>
          </tr>
          <tr>
            <th style="text-align: center; font-size: 15px;" scope="row">No. 200</th>
            <td>0.075</td>
            <td><input type="text" name="WtRetNo2000p075" style="border: none;" size="4" style="background: transparent;"id="99" oninput="calcular()"></td>
            <td><input type="text" name="PorceRetNo2000p075" style="border: none;" size="4" style="background: transparent;"id="100" oninput="calcular()"></td>
            <td><input type="text" name="CumRetNo2000p075" style="border: none;" size="4" style="background: transparent;"id="101" oninput="calcular()"></td>
            <td><input type="text" name="PorcePassNo2000p075" style="border: none;" size="4" style="background: transparent;"id="102" oninput="calcular()"></td>
            <td><input type="text" name="SpecsNo2000p075" value="0-1.7" style="text-align: center; border: none;" size="4" style="background: transparent;"id="103" oninput="calcular()"></td>
          </tr>
          <tr>
            <th style="text-align: center;" scope="row" colspan="2">Pan</th>
            <td><input type="text" name="WtRetPan" style="border: none;" size="4" style="background: transparent;"id="104" oninput="calcular()"></td>
            <td><input type="text" name="PorceRetPan" style="border: none;" size="4" style="background: transparent;"id="105" oninput="calcular()"></td>
    ...
    <table class="table table-bordered" style="width: 320px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" name="D15" style="border: none; background: transparent; text-align: center;" id="121" oninput="calcularD()"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="D85" style="border: none; background: transparent; text-align: center;" id="124" oninput="calcularD()"></td>
            </tr>
            <tr>
...
<button type="submit" name="GrainSizeCoarse" class="btn btn-danger">Registrar ensayo</button>
