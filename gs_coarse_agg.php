    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" value="100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="51" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" value="87-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="57" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" value="80-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="63" oninput="calcular()"></td>
            </tr>
          <tr>
            ...
            <td><input type="text" value="40-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>          </tr>
          <tr>
            ...
            <td><input type="text" value="7-60"style="text-align: center; border: none;" size="4" style="background: transparent;"id="75" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" value="0-15"style="text-align: center; border: none;" size="4" style="background: transparent;"id="80" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" style="text-align: center; border: none;" size="4" style="background: transparent;"id="84" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" style="text-align: center; border: none;" size="4" style="background: transparent;"id="89" oninput="calcular()"></td>
            <td><input type="text" value="0-7" style="text-align: center; border: none;" size="4" style="background: transparent;"id="90" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input type="text" style="text-align: center; border: none;" size="4" style="background: transparent;"id="94" oninput="calcular()"></td>          
            <td><input type="text" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="90" oninput="calcular()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" value="0-1.7" style="text-align: center; border: none;" size="4" style="background: transparent;"id="103" oninput="calcular()"></td>
          </tr>
          <tr>
...
<button type="submit" name="gs_coarse_agg" class="btn btn-danger">Registrar ensayo</button>
