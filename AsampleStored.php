        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Disturbed Samples Stored List</span>
                </strong>
            </div>
...
foreach ($tablas as $tabla) {
    $query = "SELECT id, Sample_ID, Sample_Number, Sample_Type, Depth_From, Depth_To, Sample_Weight, Comment, Sample_Date, Store_In FROM $tabla WHERE Store_In = 'Stored_PVLab'";
