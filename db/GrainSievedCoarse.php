...
<?php
$search_table = find_by_id('grain_size_sieved_coarse_aggregate', (int)$_GET['id']);
  ...
  if (isset($_POST['update_muestra'])) {
    ...
    // Tamizes  
      ...
      $query = "UPDATE grain_size_sieved_coarse_aggregate SET ";
      ...
      if ($result && $db->affected_rows() === 1) {
        ...
        redirect('Revision-GS-Sieved-Coarse.php?id=' . $search_table['id'], false);
      } else {
...
if (isset($_POST['repetir_muestra'])) {
    ...
    $query_select = "SELECT * FROM grain_size_sieved_coarse_aggregate WHERE id = '{$search_table}'";
