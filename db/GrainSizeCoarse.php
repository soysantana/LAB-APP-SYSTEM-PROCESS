...
if (isset($_POST['GrainSizeCoarse'])) {
    $req_fields = array(
        'sampleid',
        'samplenumber',
        'structure',
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO grain_size_coarse_aggregate (
        ...
        if ($db->query($sql)) {
            ...
            redirect('./gs_coarse_agg.php', false);
        } else {
...
<?php
$search_table = find_by_id('grain_size_coarse_aggregate', (int)$_GET['id']);
  ...
  if (isset($_POST['update_muestra'])) {
    ...
    // Reactivity Test Method
      $TotalSampleWeightg = $db->escape($_POST['TotalSampleWeightg']);
      ...
      $WeightMatRetNo4IfApplicable = $db->escape($_POST['WeightMatRetNo4IfApplicable']);
      $WtReactivePartRetNo4IfApplicable = $db->escape($_POST['WtReactivePartRetNo4IfApplicable']);
      $PercentReactiveParticlesIfApplicable = $db->escape($_POST['PercentReactiveParticlesIfApplicable']);
      ...
      $GrainSizeTestResult = $db->escape($_POST['GrainSizeTestResult']);
      $FineGrainedClassificationusingtheUSCS = $db->escape($_POST['FineGrainedClassificationusingtheUSCS']);
    ...
    // Tamizes  
      ...
      $query = "UPDATE grain_size_coarse_aggregate SET ";
      ...
      $query .= "Total_Sample_Weight_g = '{$TotalSampleWeightg}', ";
      ...
      $query .= "Weight_Mat_Ret_No_4_If_Applicable = '{$WeightMatRetNo4IfApplicable}', ";
      $query .= "Wt_Reactive_Part_Ret_No4_If_Applicable = '{$WtReactivePartRetNo4IfApplicable}', ";
      $query .= "Percent_Reactive_Particles_If_Applicable = '{$PercentReactiveParticlesIfApplicable}', ";
      ...
      $query .= "Grain_Size_Test_Result = '{$GrainSizeTestResult}', ";
      $query .= "Fine_Grained_Classification_using_the_USCS = '{$FineGrainedClassificationusingtheUSCS}', ";
      ...
      if ($result && $db->affected_rows() === 1) {
        ...
        redirect('Revision-GS-Coarse.php?id=' . $search_table['id'], false);
      } else {
...
if (isset($_POST['repetir_muestra'])) {
    ...
    $query_select = "SELECT * FROM grain_size_coarse_aggregate WHERE id = '{$search_table}'";
