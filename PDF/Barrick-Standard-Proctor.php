...
//Sample Information
$pdf->SetXY(169.5, 34);
$pdf->Cell(36, 5, 'LBOR23', 0, 1, 'L');
$pdf->SetXY(169.5, 39);
$pdf->Cell(36, 5, 'T-27', 0, 1, 'L');
$pdf->SetXY(169.5, 44);
$pdf->Cell(36, 5, 'LBOR', 0, 1, 'L');
$pdf->SetXY(238, 34);
$pdf->Cell(39, 5, 'LBOR23-00011', 0, 1, 'L');
$pdf->SetXY(238, 39);
$pdf->Cell(39, 5, 'LPF', 0, 1, 'L');
$pdf->SetXY(238, 44);
$pdf->Cell(39, 5, '-', 0, 1, 'L');
$pdf->SetXY(309.5, 34);
$pdf->Cell(40, 5, '-', 0, 1, 'L');
...
$pdf->Cell(40, 5, '-', 0, 1, 'L');
$pdf->SetXY(382, 34);
$pdf->Cell(33, 5, '2023-10-05', 0, 1, 'L');
$pdf->SetXY(382, 39);
...
$pdf->SetXY(480, 39);
$pdf->Cell(27, 5, 'LS', 0, 1, 'L');
$pdf->SetXY(480, 44);
$pdf->Cell(27, 5, 'ASTM-D698', 0, 1, 'L');
$pdf->SetXY(540, 34);
$pdf->Cell(32, 5, 'A', 0, 1, 'L');
$pdf->SetXY(540, 39);
$pdf->Cell(32, 5, '2023-10-31', 0, 1, 'L');
$pdf->SetXY(540, 44);
$pdf->Cell(32, 5, '2023-11-07', 0, 1, 'L');
//Testing Information
$pdf->SetXY(94.4, 54);
...
$pdf->Cell(35, 6, $SeachTable['MC_Wt_Wet_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 139.5);
$pdf->Cell(35.5, 6, $SeachTable['MC_Wt_Wet_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(205, 139.5);
$pdf->Cell(32.5, 6, $SeachTable['MC_Wt_Wet_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 139.5);
$pdf->Cell(39.5, 6, $SeachTable['MC_Wt_Wet_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(277, 139.5);
$pdf->Cell(32.5, 6, $SeachTable['MC_Wt_Wet_Soil_Tare_1'], 0, 1, 'C');
...
$pdf->Cell(35, 8, $SeachTable['MC_Wt_Dry_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 145.5);
$pdf->Cell(35.5, 8, $SeachTable['MC_Wt_Dry_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(205, 145.5);
$pdf->Cell(32.5, 8, $SeachTable['MC_Wt_Dry_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 145.5);
$pdf->Cell(39.5, 8, $SeachTable['MC_Wt_Dry_Soil_Tare_1'], 0, 1, 'C');
$pdf->SetXY(277, 145.5);
$pdf->Cell(32.5, 8, $SeachTable['MC_Wt_Dry_Soil_Tare_1'], 0, 1, 'C');
...
$pdf->SetXY(134.5, 153);
$pdf->Cell(35, 8.5, $SeachTable['Wt_Water_g_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 153);
$pdf->Cell(35.5, 8.5, $SeachTable['Wt_Water_g_1'], 0, 1, 'C');
$pdf->SetXY(205, 153);
$pdf->Cell(32.5, 8.5, $SeachTable['Wt_Water_g_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 153);
$pdf->Cell(39.5, 8.5, $SeachTable['Wt_Water_g_1'], 0, 1, 'C');
$pdf->SetXY(277, 153);
$pdf->Cell(32.5, 8.5, $SeachTable['Wt_Water_g_1'], 0, 1, 'C');
...
$pdf->Cell(35,7, $SeachTable['Tare_g_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 161.5);
$pdf->Cell(35.5,7, $SeachTable['Tare_g_1'], 0, 1, 'C');
$pdf->SetXY(205, 161.5);
$pdf->Cell(32.5,7, $SeachTable['Tare_g_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 161.5);
$pdf->Cell(39.5,7, $SeachTable['Tare_g_1'], 0, 1, 'C');
$pdf->SetXY(277, 161.5);
$pdf->Cell(32.5,7, $SeachTable['Tare_g_1'], 0, 1, 'C');
...
$pdf->SetXY(134.5, 169);
$pdf->Cell(35, 8, $SeachTable['MC_Wt_Dry_Soil_g_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 169);
$pdf->Cell(35.5, 8, $SeachTable['MC_Wt_Dry_Soil_g_1'], 0, 1, 'C');
$pdf->SetXY(205, 169);
$pdf->Cell(32.5, 8, $SeachTable['MC_Wt_Dry_Soil_g_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 169);
$pdf->Cell(39.5, 8, $SeachTable['MC_Wt_Dry_Soil_g_1'], 0, 1, 'C');
$pdf->SetXY(277, 169);
$pdf->Cell(32.5, 8, $SeachTable['MC_Wt_Dry_Soil_g_1'], 0, 1, 'C');
...
$pdf->SetXY(134.5, 177);
$pdf->Cell(35, 8.5, $SeachTable['MC_Porce_1'], 0, 1, 'C');
$pdf->SetXY(169.5, 177);
$pdf->Cell(35.5, 8.5, $SeachTable['MC_Porce_1'], 0, 1, 'C');
$pdf->SetXY(205, 177);
$pdf->Cell(32.5, 8.5, $SeachTable['MC_Porce_1'], 0, 1, 'C');
$pdf->SetXY(237.5, 177);
$pdf->Cell(39.5, 8.5, $SeachTable['MC_Porce_1'], 0, 1, 'C');
$pdf->SetXY(277, 177);
$pdf->Cell(32.5, 8.5, $SeachTable['MC_Porce_1'], 0, 1, 'C');
