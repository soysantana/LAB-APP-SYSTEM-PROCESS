...
$MC = find_by_id('moisture_content_microwave', (int)$_GET['id']);
?>
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="mc_microwave.php" onsubmit="calcular();">
          <div class="row">
            ...
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <textarea class="form-control" name="comment" id="comment"><?php echo ($MC['Comment']); ?></textarea>
              </div>
            </div>
            ...
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input class="form-control" name="technician" value="<?php echo ($MC['Technician']); ?>" type="text" id="technician">
              </div>
            </div>
            ...
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input class="form-control" name="testdate" value="<?php echo ($MC['Test_Start_Date']); ?>" type="date" id="testdate">
              </div>
            </div>
          </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td>Trial</td>
                <td><input value="<?php echo ($MC['Trial']); ?>" type="text" class="form-control" name="trial" id="trial" oninput="calcular()"></td>
              </tr>
              <tr>
                <td>Tare Name</td>
                <td><input value="<?php echo ($MC['Tare_Name']); ?>" type="text" class="form-control" name="tarename" id="tarename" oninput="calcular()"></td>
              </tr>
              <tr>
                <td>Microwave Model</td>
                <td><input value="<?php echo ($MC['Microwave_Model']); ?>" type="text" class="form-control" name="micromodel" id="micromodel" oninput="calcular()"></td>
              </tr>
              <tr>
          ...
          <a href="PDF/MC-Microwave_Rev_1.php?id=<?php echo intval($MC['id']); ?>" class="btn btn-primary">Generar PDF</a>
        </form>
      </div>
    </div>
  </div>
