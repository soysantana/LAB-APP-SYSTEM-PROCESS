...
<div style="display: flex; flex-direction: row-reverse; margin-right: 1%; margin-top: -20%;">
    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs375" value="100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="34" oninput="calcular()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs3p419" value="80-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="59" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="Specs3p89" value="70-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo44" value="60-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="74" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo102" value="50-100"style="text-align: center; border: none;" size="4" style="background: transparent;"id="79" oninput="calcular()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="SpecsNo2000p075" value="25-94" style="text-align: center; border: none;" size="4" style="background: transparent;"id="104" oninput="calcular()"></td>
          </tr>
          <tr>
...
<div>
  <div id="gs_lpf" style="height: 600px; width: 1070px; display: flex; flex-direction: row-reverse; margin-top: -40%;"></div>
</div>
