    ...
    <table class="table table-bordered" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td rowspan="5"><input type="text" style="border: none; background: transparent; padding: 40%; width: 100%;" id="Average-Streng-Mpa" name="AverageStrenghtMpa"></td>
                <td><input type="text" style="border: none;" size="4" style="background: transparent;"id="" name="TypeFractureN1"></td>
            ...
            <tr>
                ...
                <td><input type="text" style="border: none;" size="4" style="background: transparent;"id="" name="TypeFractureN2"></td>
            ...
            <tr>
                ...
                <td><input type="text" style="border: none;" size="4" style="background: transparent;"id="" name="TypeFractureN3"></td>
            ...
            <tr>
                ...
                <td><input type="text" style="border: none;" size="4" style="background: transparent;"id="" name="TypeFractureN4"></td>
            ...
            <tr>
                ...
                <td><input type="text" style="border: none;" size="4" style="background: transparent;"id="" name="TypeMFractureN5"></td>
...
<div style="margin-left: 1%;">
    <button type="submit" name="ConcreteSpecimen" class="btn btn-danger">Registrar ensayo</button>
</div>
