      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
         <div class="pull-right">
           <a href="add_product.php" class="btn btn-primary">Agragar Articulo al inventario</a>
         </div>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <?php echo remove_junk($product['Marca_Modelo']); ?></td>
                <td> <?php echo remove_junk($product['Codigo']); ?></td>
                <td> <?php echo remove_junk($product['Status']); ?></td>
