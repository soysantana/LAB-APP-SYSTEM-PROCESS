...
$SearchTable = find_by_id('grain_size_sieved_coarse_aggregate', (int)$_GET['id']);
?>
  ...
  <table class="table table-bordered" style="width: 380px; margin-left: 3%;">
        ...
        <tbody>
            <tr>
                ...
                <td><input value="<?php echo ($SearchTable['Acid_Reactivity_Test_Result']); ?>" type="text" name="AcidReactivityTestResult" style="border: none; background: transparent; text-align: center;" id="16" oninput="calcular()"></td>
            </tr>
        </tbody>
    </table>
</div>
...
<div style="display: flex; flex-direction: row-reverse; margin-right: 1%; margin-top: -60%;">
    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_1p5_37']); ?>" type="text" name="Specs1p537" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="51" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_1_25']); ?>" type="text" name="Specs125" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="57" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_3p4_19']); ?>" type="text" name="Specs3p419" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="63" oninput="calcular()"></td>
            </tr>
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_3p8_9']); ?>" type="text" name="Specs3p89" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>          </tr>
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_No4_4']); ?>" type="text" name="SpecsNo44" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="75" oninput="calcular()"></td>
          ...
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_No10_2']); ?>" type="text" name="SpecsNo102" value=""style="text-align: center; border: none;" size="4" style="background: transparent;"id="80" oninput="calcular()"></td>
          </tr>
          ...
          <tr>
            ...
            <td><input value="<?php echo ($SearchTable['Specs_No200_0p075']); ?>" type="text" name="SpecsNo2000p075" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="103" oninput="calcular()"></td>
          </tr>
          <tr>
    ...
    <table class="table table-bordered" style="width: 300px;">
        ...
        <tbody>
            <tr>
                ...
                <td><input value="<?php echo ($SearchTable['Grain_Size_Test_Result']); ?>" type="text" name="GrainSizeTestResult" style="border: none; background: transparent; text-align: center;" id="114" oninput="calcular()"></td>
            </tr>
        </tbody>
    </table>
  </div>
  ...
  <div style="display: flex; flex-direction: row-reverse; margin-right: 18%; margin-top: 5%;">
    <table class="table table-bordered border-primary" style="width: 480px;">
        ...
        <tbody>
            <tr>
                <td><input value="<?php echo ($SearchTable['Fine_Grained_Classification_using_the_USCS']); ?>" type="text" name="FineGrainedClassificationusingtheUSCS" style="border: none; background: transparent; text-align: center;" size="40" id="115" oninput="calcular()"></td>
            </tr>
...
<a href="PDF/Grain_Size_CTA_Rev_1.php?id=<?php echo intval($SearchTable['id']); ?>" class="btn btn-primary">Generar PDF</a>
