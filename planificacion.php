...
?>
    ...
    <div style="display: flex; flex-direction: row-reverse; justify-content: space-around; margin-top: 2%;">
        <button type="button" class="btn btn-primary"><a href="home.php" style='color: white;'>Volver Atras</a></button>
    </div>
            ...
            $("#calendar").fullCalendar({
                ...
                eventRender: function (event, element ) {
                    ...
                    element.find(".closeon").on("click", function () {
                        var pregunta = confirm("¿Deseas borrar esta actividad?");
                        if (pregunta) {
                ...
                eventClick: function (event) {
                    ...
                    $('input[name=tecnico]').val(event.title);
