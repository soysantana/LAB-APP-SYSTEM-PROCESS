    ...
    <th style="text-align: center;" scope="col">Specs</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" name="Specs1p537" value="100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="49" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="Specs125" value="87-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="54" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="Specs3p419" value="70-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="59" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="Specs3p89" value="33-100" style="text-align: center; border: none;" size="4" style="background: transparent;"id="69" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo44" value="7-60" style="text-align: center; border: none;" size="4" style="background: transparent;"id="74" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo102" value="0-15"style="text-align: center; border: none;" size="4" style="background: transparent;"id="79" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo161" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="84" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo200p85" value="0-7" style="text-align: center; border: none;" size="4" style="background: transparent;"id="89" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo500p3" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="94" oninput="calcular()"></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="SpecsNo600p25" value="" style="text-align: center; border: none;" size="4" style="background: transparent;"id="99" oninput="calcular()"></td>
          </tr>
          <tr>
...
<div>
  <div id="gs_cf" style="height: 600px; width: 1070px; display: flex; flex-direction: row-reverse; margin-top: -25%;"></div>
</div>
