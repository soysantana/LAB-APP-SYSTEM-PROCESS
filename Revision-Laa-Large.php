        ...
        <tbody>
            <tr>
                ...
                <td><select name="SelectedGrading" id="" class="form-control" style="border: none;" style="background: transparent;">
                    <option <?php if ($search_table['Selected_Grading'] == '1') echo 'selected'; ?>>1</option>
                    <option <?php if ($search_table['Selected_Grading'] == '2') echo 'selected'; ?>>2</option>
                    <option <?php if ($search_table['Selected_Grading'] == '3') echo 'selected'; ?>>3</option>
                </select></td>
            </tr>
        </tbody>
    </table>
...
<a href="PDF/LAA_LS_Rev_1.php?id=<?php echo intval($search_table['id']); ?>" class="btn btn-primary">Generar PDF</a>
