...
<option <?php if ($LAA['Preparation_Method'] == 'Oven_Dried') echo 'selected'; ?>>Oven Dried</option>
<option <?php if ($LAA['Preparation_Method'] == 'Air_Dried') echo 'selected'; ?>>Air Dried</option>   
</select>
</div>
        ...
        <tbody>
            <tr>
                ...
                <td><select name="SelectedGrading" id=""  style="border: none;" style="background: transparent;">
                    ...
                    <option <?php if ($LAA['Selected_Grading'] == 'A') echo 'selected'; ?>>A</option>  
                    <option <?php if ($LAA['Selected_Grading'] == 'B') echo 'selected'; ?>>B</option>  
                    <option <?php if ($LAA['Selected_Grading'] == 'C') echo 'selected'; ?>>C</option>  
                    <option <?php if ($LAA['Selected_Grading'] == 'D') echo 'selected'; ?>>D</option>
                </select></td>
            </tr>
        </tbody>
    </table>
...
<a href="PDF/LAA_CA_Rev_1.php?id=<?php echo intval($LAA['id']); ?>" class="btn btn-primary">Generar PDF</a>
</div>
</form>
