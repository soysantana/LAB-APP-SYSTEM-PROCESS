 ...
 <div class="row">
  ...
  <div class="col-md-6">
     <div class="panel panel-default">
       ...
       <div class="panel-body">
          <form method="post" action="User/edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="User/edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          <div class="form-group">
