...
<div>
  ...
  <td><input type="text" style="border: none;" size="12" style="background: transparent;"id="2" name="Tare_Wet_Soil"></td>
  </tr>
  
  <tr>
  <th style="font-size: 15px;" style="width: 150px; height: 25px;"scope="row">Wt Dry Soil + Tare (gr):</th>
  <td><input type="text" style="border: none;" size="12" style="background: transparent;"id="3" name="Tare_Dry_Soil" oninput="calcular()"></td>
  </tr>
  ...
  <td><input type="text" style="border: none;" size="12" style="background: transparent;"id="5" name="Dry_Soil" oninput="calcular()"></td>
  </tr>
  ...
  <td><input type="text" style="border: none;" size="12" style="background: transparent;"id="7" name="Wash_Pan" oninput="calcular()"></td>
  </tr>
  </table>
</div>
...
<div style="margin-left: 1%;">
  ...
  <tbody>
      <tr>
        ...
        <td><input type="text" style="border: none;" size="12" style="background: transparent;"id="112" name="Coarser_than_Gravel" oninput="calcular()"></td>
      </tr>
      <tr>
